...
This variant introduces center-relative positional encoding for 3D patches.
    ...
    def create_enhanced_position_embeddings(self, embed_dim, img_size, patch_size):
        ...
        for i in range(num_patches):
            ...
            if self.use_spherical:
                ...
                phi = torch.atan2(torch.tensor(dz), torch.sqrt(torch.tensor(dx ** 2 + dy ** 2)))
...
if __name__ == "__main__":
    ...
    model = ChannelTransformer(config=config, vis=False, img_size=128)
    en1 = torch.rand((1, 64, 128, 128, 128))
    en2 = torch.rand((1, 128, 64, 64, 64))
    en3 = torch.rand((1, 256, 32, 32, 32))
    en4 = torch.rand((1, 512, 16, 16, 16))
