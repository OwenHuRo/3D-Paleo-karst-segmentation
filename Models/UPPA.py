"""
Initial UPPA prototype based on a shallow 3D U-Net.

This version introduces enhanced downsampling paths to deliver shallow
encoder features to deeper decoder stages for multi-scale feature fusion.
"""
...
class UPPA(nn.Module):
    def __init__(self, input_channels=1, output_channels=1):
        super(UPPA, self).__init__()
        nf1 = 32
        nf2 = 64
        nf3 = 128
        nf4 = 256
