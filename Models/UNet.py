...
"""
A compact 3D U-Net for volumetric image segmentation.
Compared with the standard U-Net architecture, this model uses one fewer
encoder-decoder level. This design is chosen according to the spatial size
of the input voxel grid, since an additional downsampling operation would
make the feature maps too small and may cause excessive loss of spatial
information.
"""
