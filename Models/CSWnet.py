"""
Spatial-attention extension of the experimental CWnet architecture.

The underlying encoder, decoder, and Channel Transformer are adapted from
...
class CSWnet(nn.Module):
    def __init__(self, config,n_channels=1, n_classes=1,img_size=128,vis=False):
        ...
        self.mtc = ChannelTransformerPlusSpatial(config, vis, img_size,
